...
class BoatsControllerTest < ActionController::TestCase
  ...
  test "should create boat" do
    assert_difference('Boat.count') do
      post :create, boat: { CompleteDate: @boat.CompleteDate, StartDate: @boat.StartDate, customer_id: @boat.customer_id, length: @boat.length, type: @boat.type }
    end
  ...
  test "should update boat" do
    patch :update, id: @boat, boat: { CompleteDate: @boat.CompleteDate, StartDate: @boat.StartDate, customer_id: @boat.customer_id, length: @boat.length, type: @boat.type }
    assert_redirected_to boat_path(assigns(:boat))
  end
