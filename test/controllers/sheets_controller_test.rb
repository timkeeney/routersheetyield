...
class SheetsControllerTest < ActionController::TestCase
  ...
  test "should create sheet" do
    assert_difference('Sheet.count') do
      post :create, sheet: { alloy: @sheet.alloy, date: @sheet.date, desc: @sheet.desc, matThick: @sheet.matThick, poNum: @sheet.poNum, sheetH: @sheet.sheetH, sheetW: @sheet.sheetW }
    end
  ...
  test "should update sheet" do
    patch :update, id: @sheet, sheet: { alloy: @sheet.alloy, date: @sheet.date, desc: @sheet.desc, matThick: @sheet.matThick, poNum: @sheet.poNum, sheetH: @sheet.sheetH, sheetW: @sheet.sheetW }
    assert_redirected_to sheet_path(assigns(:sheet))
  end
